...
v_objspace:	        rs.b $600       ; RAM for object space ($600 bytes)
f_victory:	        rs.b $200       ; flag for victory animation
LevelObjectsList:       rs.b ObSize*$5F

                        ; unused, unknown data
                        rs.b $40        ; prob an slot but doesnt get accessed anyway
